...
- **salaryMin, salaryMax（年収）**: 様々な表記形式（万円、月給、時給など）に対応し、円単位に統一。
  - 範囲がある場合（例：「500万円台から1300万円台まで」）は、salaryMinとsalaryMaxの両方を正確に抽出
  - 「500万円以上」のような表記の場合は、salaryMinのみ設定
  - 平均や中央値ではなく、実際の範囲を抽出することが重要
- **salaryBand（年収帯）**: salaryMaxに基づいて自動計算（〜500, 500-700, 700-900, 900+）。フィルター用の補助情報。
...
- **requiredPerson（求める人物像・応募要件）**: 人柄や性格だけでなく、応募要件（必須スキル、経験、資格、歓迎スキルなど）も含めて抽出。以下のセクションから統合的に抽出：
  - 「求める人物像」「こんな方を求めています」「人物像」
  - 「応募要件」「必須要件」「必要要件」
  - 「必須スキル」「必要スキル」「スキル要件」
  - 「経験・資格」「必須経験」「資格要件」
  - 「歓迎スキル」「歓迎要件」
  500文字程度まで抽出（長すぎる場合は要約）。
